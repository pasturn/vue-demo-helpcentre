...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vue = __webpack_require__(1),
	    ...
	    VueResource = __webpack_require__(15),
	    common  = __webpack_require__(77),
	    index = __webpack_require__(65),
	    detail = __webpack_require__(68);
	;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./sm.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./sm.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	function install(Vue) {
	    ...
	    Vue.url = __webpack_require__(17);
	    Vue.http = __webpack_require__(23);
	    Vue.resource = __webpack_require__(38);
	    Vue.Promise = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UrlTemplate = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var interceptor = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(16);
	var Promise = __webpack_require__(25);
	var xhrClient = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(16);
	var PromiseObj = window.Promise || __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jsonpClient = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(16);
	var xdrClient = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Volumes/CoolBee/Code/helpcentre/src/components/common/header.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Volumes/CoolBee/Code/helpcentre/src/components/index/search.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	//             <input type="search" id='search' placeholder='输入关键字...' v-model="search"/>
	//         </div>
	//     </div>
	// </template>
	// <script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Volumes/CoolBee/Code/helpcentre/src/components/index/list.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    methods: {
	        answer: function answer(title, _answer) {
	            this.$dispatch('answerpage', { 'title': title, 'answer': _answer });
	        }
	    }
	};
	// </script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Volumes/CoolBee/Code/helpcentre/src/components/index/index.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Volumes/CoolBee/Code/helpcentre/src/components/detail/detail.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Volumes/CoolBee/Code/helpcentre/src/components/app.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	//         <bar-nav></bar-nav>
	//     </header>
	//     <router-view :pageanswer="faq"></router-view>
	//     <!--<div class="content infinite-scroll infinite-scroll-bottom">-->
	...
	exports.default = {
	    ...
	    components: {
	        'bar-nav': __webpack_require__(51)
	    },
	    events: {
	        'answerpage': function answerpage(faq) {
	            this.$set('faq', faq);
	        }
	    }
	};
